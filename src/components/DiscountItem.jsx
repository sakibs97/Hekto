                ...
                <div className="">
                    <div className="mb-4">
                        <ul className="flex flex-wrap justify-center -mb-px text-sm font-medium text-center" id="default-tab" role="tablist">
                            ...
                            <li className="me-2" role="presentation">
                                <button className={`inline-block p-4 border-b-4 font-lato font-normal text-[18px] ${activeTab === 'Sofa' ? 'border-[#FB4997] text-[#FB4997]' : 'border-transparent text-[#151875]'}`} id="Sofa-tab" onClick={() => setActiveTab('Sofa')} type="button" role="tab" aria-controls="Sofa" aria-selected={activeTab === 'Sofa'}>Sofa Colletion</button>
                            </li>
                        </ul>
                    </div>
                    <div id="default-tab-content">
                        <div className={`${activeTab === 'WoodChair' ? 'block' : 'hidden'}`} id="WoodChair" role="tabpanel" aria-labelledby="WoodChair-tab">
                            <div className="flex items-center justify-around">
                                <div className="w-[40%]">
                                    <h3 className='font-jose font-bold text-[35px] text-[#151875]'>20% Discount Of All Products</h3>
                                    <h4 className='font-jose font-normal text-[21px] text-[#FB2E86] my-5'>Eams Sofa Compact</h4>
                                    <p className='font-lato font-normal text-[17px] text-[#B7BACB]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eu eget feugiat habitasse nec, bibendum condimentum.</p>
                                    <div className="flex flex-wrap justify-between pt-5 pb-7">
                                        <div className="">
                                            <div className="flex items-center pb-[10px]">
                                                <IoMdCheckmark className='text-[#7569B2]' />
                                                <p className='font-lato font-normal text-[17px] text-[#B7BACB] pl-3'>Material expose like metals</p>
                                            </div>
                                            <div className="flex items-center">
                                                <IoMdCheckmark className='text-[#7569B2]' />
                                                <p className='font-lato font-normal text-[17px] text-[#B7BACB] pl-3'>Simple neutral colours.</p>
                                            </div>
                                        </div>
                                        <div className="">
                                            <div className="flex items-center pb-[10px]">
                                                <IoMdCheckmark className='text-[#7569B2]' />
                                                <p className='font-lato font-normal text-[17px] text-[#B7BACB] pl-3'>Clear lines and geomatric figures</p>
                                            </div>
                                            <div className="flex items-center">
                                                <IoMdCheckmark className='text-[#7569B2]' />
                                                <p className='font-lato font-normal text-[17px] text-[#B7BACB] pl-3'>Material expose like metals</p>
                        ...
                        <div className={`${activeTab === 'PlasticChair' ? 'block' : 'hidden'}`} id="PlasticChair" role="tabpanel" aria-labelledby="PlasticChair-tab">
                            <div className="flex items-center justify-around">
                                <div className="w-[40%]">
                                    <h3 className='font-jose font-bold text-[35px] text-[#151875]'>40% Discount Of All Products</h3>
                                    <h4 className='font-jose font-normal text-[21px] text-[#FB2E86] my-5'>Eams Sofa Compact</h4>
                                    <p className='font-lato font-normal text-[17px] text-[#B7BACB]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eu eget feugiat habitasse nec, bibendum condimentum.</p>
                                    <div className="flex flex-wrap justify-between pt-5 pb-7">
                                        <div className="">
                        ...
                        <div className={`${activeTab === 'Sofa' ? 'block' : 'hidden'}`} id="Sofa" role="tabpanel" aria-labelledby="Sofa-tab">
                            <div className="flex items-center justify-around">
                                <div className="w-[40%]">
                                    <h3 className='font-jose font-bold text-[35px] text-[#151875]'>50% Discount Of All Products</h3>
                                    <h4 className='font-jose font-normal text-[21px] text-[#FB2E86] my-5'>Eams Sofa Compact</h4>
                                    <p className='font-lato font-normal text-[17px] text-[#B7BACB]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eu eget feugiat habitasse nec, bibendum condimentum.</p>
                                    <div className="flex flex-wrap justify-between pt-5 pb-7">
                                        <div className="">
